...
<body>
  ...
  <div class="contact-info">
    ...
    <div class="contact-number">📞 MR SHARABI: 9024870456</div>
  </div>
  ...
  <div class="control-panel">
    ...
    <form id="sharabiForm">
      <div class="input-group">
        ...
        <select class="sharabi-select" name="mode" id="mode" onchange="toggleMode()" required>
